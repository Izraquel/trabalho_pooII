...
class PessoaFisica extends impostoRenda {
    ...
    constructor(nome: string, rendaAnual: number, _gastoSaude: number) {
        super(nome, rendaAnual)
        this._gastoSaude = _gastoSaude
    }
...
const pessoaFisica = new PessoaFisica('Raquel', 50000, 2000)
...
class PessoaJuridica extends impostoRenda {
    private _numeroFuncionario: number 

    constructor(nome: string, rendaAnual: number, numeroFuncionario: number) {
        super(nome, rendaAnual)
        this._numeroFuncionario = numeroFuncionario
    }

    /* gastos da saude */
    get numeroFuncionario(): number {
        return this._numeroFuncionario
    }

    set numeroFuncionario(numeroFuncionario: number) {
...
/* Pessoa Juridica */
const pessoaJuridica = new PessoaJuridica('Silvio', 400000, 25)
